package com.misura.transactionviewer.dummy;
...
public class DummyContent {
    ...
    private static Product createDummyItem(int position) {
        return new Product(String.valueOf(position), "Item " + position, makeDetails(position));
    }
    ...
    public static class Product {
        ...
        public Product(String id, String content, String details) {
            this.id = id;
